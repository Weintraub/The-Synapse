...
$("#cd-intro-about").click(function() {
	$('html, body').animate({
		scrollTop: $("#-txt").offset().top
	}, 2000);
});

$("#cd-intro-speaker").click(function() {
	$('html, body').animate({
		scrollTop: $("#more").offset().top
	}, 2000);
});

$("#cd-intro-project").click(function() {
	$('html, body').animate({
		scrollTop: $("#more").offset().top
	}, 2000);
});

$("#cd-intro-team").click(function() {
	$('html, body').animate({
		scrollTop: $("#more").offset().top
	}, 2000);
});
...
window.onload = function(){
  document.getElementById('fun').click();
}

// custom google map settings
jQuery(document).ready(function($){
	//set your google maps parameters
	var latitude = 43.690681,
	longitude = -79.404700,
	map_zoom = 16;
